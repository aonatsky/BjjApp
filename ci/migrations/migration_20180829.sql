...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20180825193237_AdditionalEventDataAdded') THEN
    ALTER TABLE "Event" ADD "BracketsPublished" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20180825193237_AdditionalEventDataAdded') THEN
    ALTER TABLE "Event" ADD "CorrectionsEnabled" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20180825193237_AdditionalEventDataAdded') THEN
    ALTER TABLE "Event" ADD "ParticipantListsPublished" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20180825193237_AdditionalEventDataAdded') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20180825193237_AdditionalEventDataAdded', '2.1.1-rtm-30846');
    END IF;
END $$;
